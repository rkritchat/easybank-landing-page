const pageDetail = {
    logo: '/logo.svg',
    logo_alt: 'easybank',
    facebook_icon: '/icon-facebook.svg',
    facebook_alt: 'facebook',
    youtube_icon: '/icon-youtube.svg',
    youtube_alt: 'youtube',
    twitter_icon: '/icon-twitter.svg',
    twitter_alt: 'twitter',
    pinterest_icon: '/icon-pinterest.svg',
    pinterest_alt: 'pinterest',
    instagram_icon: '/icon-instagram.svg',
